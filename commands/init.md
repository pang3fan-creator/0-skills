...
1. `~/.agents/skills/interface-design/SKILL.md` — the foundation, principles, and checks
2. `~/.agents/skills/interface-design/references/principles.md` — detailed craft including subtle layering
3. `~/.agents/skills/interface-design/references/example.md` — how decisions translate to code
