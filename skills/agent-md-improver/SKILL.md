...
Audit, evaluate, and improve AGENTS.md files across a codebase to ensure the agent has optimal project context.
...
**Note:** Open Code auto-discovers AGENTS.md files in parent directories, making monorepo setups work automatically.
...
- **Check into git**: AGENTS.md should be committed and shared with the team
